// === LOCKED FILE (soft) === Status: STABLE — QC-verified 2026-06-20 (owner-approved).
// 2026-06-21 (owner-approved): BUANG architect "Build a team" + sub-tab CHAT dari tab Group — keduanya
//   PINDAH ke AI Studio (hindari duplikat: team-builder & chat satu pintu di AI Studio). Tab Group
//   sekarang fokus kelola roster/grup. Kontrol tersisa & teruji: DEPLOY/create, Restore, ON/OFF toggle
//   (cascade), SAVE ROSTER (members/synthesizer/task/mode/rounds), DELETE, mode→rounds. RE-LOCKED.
//
...
/* architect bar + chat sub-tab DIHAPUS (owner 2026-06-21): build-team & chat pindah ke AI Studio. */
`;
...
export async function render(mainEl) {
  ...
  `;
  // Build-team (architect) & Chat DIHAPUS dari tab Group (owner 2026-06-21): keduanya di AI Studio.
  // Tab ini fokus kelola roster/grup; chat ke grup lewat AI Studio (dropdown target group).
