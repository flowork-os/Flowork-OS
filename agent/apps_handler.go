// === LOCKED FILE (soft) — STABLE. Audit rilis 2026-06-14 (menu App, §37 TUTORIAL): aman. ===
// auth-gated; appsUIHandler anti path-traversal (filepath.Rel + tolak ".."); id tervalidasi. DO NOT MODIFY tanpa owner.
