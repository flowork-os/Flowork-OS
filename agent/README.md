...
```bash
git clone https://github.com/flowork-os/Flowork-OS.git && cd Flowork_Agent && ./start.sh
```
...
### 👉 **[Flowork Router → github.com/flowork-os/flowork_Router](https://github.com/flowork-os/Flowork-OS)**
...
[GitHub](https://github.com/flowork-os/Flowork-OS) • [Router](https://github.com/flowork-os/Flowork-OS) • [Telegram](https://t.me/+55oqrk75lc43YWE1)
