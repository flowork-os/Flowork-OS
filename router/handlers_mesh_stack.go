...
func countRows(db *sql.DB, table string) int {
	var n int
	// `table` selalu dari daftar tabel hardcoded (schema), bukan input user; nama tabel tak
	// bisa di-parameterize → concat wajar, aman dari SQL injection. // scanner:ignore
