...
// Reason: Claude anti-ban cloaking — faithful Go port of proven open-source logic.
//
// cloaking.go — Claude tool cloaking (anti-ban). Faithful Go port of a proven,
// stable open-source reference implementation. Active ONLY when the upstream is driven by a
...
// this cloaking mitigates. API-key / no-auth providers are left untouched.
