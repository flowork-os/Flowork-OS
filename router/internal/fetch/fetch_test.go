...
// TestMain enables loopback dialing for the whole package: these tests fetch
// from httptest servers on 127.0.0.1, which the production SSRF dial guard
// (safeDialContext) correctly blocks. Production keeps allowPrivateDial=false.
